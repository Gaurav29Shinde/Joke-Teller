...
function tellMe(joke){
    VoiceRSS.speech({
        key: 'dbd33c7d105e48e7a0d8e2b557a468c7', //Enter your own API key here!
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
//Get a joke from Joke API
async function getJokes(){
    let joke = '';
    const apiUrl = 'https://sv443.net/jokeapi/v2/joke/Programming,Miscellaneous?blacklistFlags=nsfw,religious,political,racist,sexist&idRange=0-185';
    try{
